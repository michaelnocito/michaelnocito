...
I also draw charcoal portraits — mostly dogs, occasionally cats. People have been asking about commissions for years. I finally made a site for that.
...
### 📗 [Excel Sales Sprint — Interview Confidence, One Formula at a Time](https://michaelnocito.github.io/excel-sales-sprint/) *(beta)*
A free browser game that teaches beginner Excel skills for analyst interviews through layered repetition. Help Srbina go from "I know a little Excel" to interview-ready — by reading tables, writing SUM and AVERAGE, and connecting numbers to plain-English business takeaways. Fun, no install, feedback welcome.

**→ [excel-sales-sprint](https://github.com/michaelnocito/excel-sales-sprint)** &nbsp;·&nbsp; HTML · JavaScript · Web Audio API
...
### 🎨 [Charcoal Portraits — The Art Side](https://michaelnocito.github.io/art/)
I've been drawing charcoal portraits for about ten years. Mostly dogs. Occasionally cats. One at a time, from a single photo. The site has the work, the process, and how to reach me if you want one made.

**→ [art](https://michaelnocito.github.io/art/)** &nbsp;·&nbsp; Charcoal · colored pencil · chalk
